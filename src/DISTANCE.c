...
/* values for sensor 1 and 2 to calculate and return */
...
void Sensor1_GPIO_Init(void) {
	...
	GPIOA->AFR[1] &= ~GPIO_AFRH_AFSEL9;			// Alternate Function AF1
...
void Sensor2_GPIO_Init(void) {
	...
	GPIOA->AFR[1] &= ~GPIO_AFRH_AFSEL10;		// Alternate Function AF1
...
/* TIM1CH3 (trigger) and TIM3CH1 (input capture)*/
...
/* return distance from object to sensor 1 in cm */
int get_Distance_S1(void) {
	return timeInterval_s1 / 58;
}

/* return distance from object to sensor 2 in cm */
